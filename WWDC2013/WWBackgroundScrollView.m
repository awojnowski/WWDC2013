...
-(void)layoutBackgroundContent {
    ...
    [winnipegImageView2 setFrame:CGRectMake(0, 900, 320, 1700)];
    ...
    [woodImageView setFrame:CGRectMake(0, 1800, 320, 1500)];
    ...
    [skyImageView setFrame:CGRectMake(0, 2400, 320, 1500)];
    ...
    [classroomImageView setFrame:CGRectMake(0, 2800, 320, 1300)];
    ...
    [keyboardImageView setFrame:CGRectMake(0, 3400, 320, 1000)];
    ...
    [writingImageView setFrame:CGRectMake(0, 3500, 320, 1500)];
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (!fadeOffsets) {
        ...
        fadeOffsets = @{
                        ...
                        @2800 : [self winnipegImageView2],
                        @3600 : [self woodImageView],
                        @3950 : [self bubbleImageView],
                        @4400 : [self classroomImageView],
                        @4700 : [self keyboardImageView]
        };
